          ...
          {data.techJourney.map((event, index) => (
            <div key={event.id} className="relative group">
              ...
              >
                ...
                {/* Left: Static banner image (no click, no lightbox) */}
                <div className="relative aspect-video md:w-[55%] overflow-hidden bg-black/40 border-b md:border-b-0 md:border-r border-card-border group-hover:border-primary-light/20 flex-shrink-0">
                  <img
                    src={event.banner}
                    alt={event.name}
